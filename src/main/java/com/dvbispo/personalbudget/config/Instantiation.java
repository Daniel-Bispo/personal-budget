...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Bill bill6 = new Bill(null, "Salário", 5, 5782.46, BillType.DEBT);
        bill6.addNotes("Desconto da farmácia em folha");
        Bill bill7 = new Bill(null, "Conta de luz", 11, 78.23, BillType.CREDIT);
        Bill bill8 = new Bill(null, "Internet", 8, 142.35, BillType.CREDIT);
        Bill bill9 = new Bill(null, "Combustível", 22, 133.88, BillType.CREDIT);
        Bill bill10 = new Bill(null, "Dividendos", 17, 1456.19, BillType.DEBT);
        bill10.addNotes("TRPL4");


        TrialBalance trialBalance1 = new TrialBalance(null, 4);
        TrialBalance trialBalance2 = new TrialBalance(null, 5);
